...
const struct wld_command_info wld_cmd_info[] =
	{
		...
		{"door", do_wdoor, 0},
		{"echo", do_wecho, 0},
		{"echoaround", do_wsend, SCMD_WECHOAROUND},
		{"exp", do_wexp, 0},
		{"force", do_wforce, 0},
		{"load", do_wload, 0},
		{"purge", do_wpurge, 0},
		{"send", do_wsend, SCMD_WSEND},
		{"teleport", do_wteleport, 0},
		{"zoneecho", do_wzoneecho, 0},
		{"damage", do_wdamage, 0},
		{"at", do_wat, 0},
		{"spellturn", do_wspellturn, 0},
		{"featturn", do_wfeatturn, 0},
		{"skillturn", do_wskillturn, 0},
		{"spelladd", do_wspelladd, 0},
		{"skilladd", do_wskilladd, 0},
		{"spellitem", do_wspellitem, 0},
		{"spellturntemp", do_wspellturntemp, 0},
		{"portal", do_wportal, 0},
		{"dgcast", WldDgCast, 0},
